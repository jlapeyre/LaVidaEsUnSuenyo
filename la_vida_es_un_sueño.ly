...
Verse_B = {
         %BAR 24
	  \override Staff.DynamicLineSpanner.padding = #1.0
          c4\p^\markup{ \fret-diagram-terse "x;3;5;5;5;x;"}
	    ^\markup{\box\tiny C}
            ^\markup{\circle\bold A}
	   \<
             <g' c e-.>8 r
...
%         \revert Score.SeparationItem.padding
          ...
          c-1^\markup{\box \tiny \line{Am (walk bass down to F\sharp) }}
           e-1 a-1 b-3 c8-4
            \stopTextSpan
             r8 gis,,8-3->^\markup{\italic II} r16   d'32-0 e-1  \tuplet 3/2 {f8-2-> e d } |
          ...
          %BAR 41
            ...
            d'16-1^\markup{"" \raise #5.0 \column{"" \raise #5.0 \small "G Maj Scale"  \raise #5.0
             ...
             \tuplet 3/2 {d16-1^\markup{\italic X} (e-3 d)} c8-4   \tuplet 3/2 {b16-1
